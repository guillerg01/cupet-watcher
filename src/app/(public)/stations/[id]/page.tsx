        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: "var(--text-muted)" }}>
              {cupet.establishment}
              {cupet.municipio ? ` · ${cupet.municipio}` : ""} · {cupet.provinceName}
            </p>
          </div>
          <span
            className="shrink-0 px-3 py-1 rounded-full text-sm font-bold"
            style={{
              background: cupet.disponible ? "var(--brand)" : "var(--surface-2)",
              color: cupet.disponible ? "#0f172a" : "var(--text-muted)",
            }}
          >
            {cupet.disponible
              ? `${cupet.disponibilidades} disponible${cupet.disponibilidades !== 1 ? "s" : ""}`
              : "Sin disponibilidad"}
          </span>
        </div>
