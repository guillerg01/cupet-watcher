...
export default async function AnalyticsPage(): Promise<React.JSX.Element> {
  ...
  return (
    <div className="space-y-10">
      ...
      {/* Stations per province bar chart */}
      <section>
      ...
      {/* Queue fill - busiest vs emptiest */}
      {queueStats.length > 0 && (
        <section>
          ...
          <div className="space-y-2">
            {queueStats.map((s) => {
              ...
              const hue = Math.round((1 - s.avgfill) * 120); // green=full empty, red=full
              return (
